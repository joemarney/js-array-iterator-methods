...
totalYearsLived = inventors.reduce(function (accumulator, age) {
  return accumulator + (age.passed - age.year);
}, 0);
...
travelMethodCounts = travelMethods.reduce(function (method, count) {
  if (method[count]) {
